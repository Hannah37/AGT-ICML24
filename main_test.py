...
def get_args():
    ...
    ### WanDB
    parser.add_argument('--run_name', default='test_adni', help='Name of wandb run')
    ### Data
...
def main():
    ...
    for i, idx_pair in enumerate(idx_pairs):
        ...
        trainer = select_trainer(args, device, model, optimizer, data_loader_train, data_loader_test, A, cv_idx = i, pretrained_net=p_net, pretrained_t=p_t) # agt

        ### best model 
        model_path = os.path.join('trained_AGT', args.data, '{}.pth'.format(i)) 
